...
@HiltViewModel
class JobInterviewViewModel @Inject constructor() : ViewModel() {
    ...
    private fun stopRecording() {
        ...
        // RecordingEntity should include:
        // - exerciseId = exerciseId (improv_job_interview)
        // - type = "improvisation"
        // - contextId = "step_${currentStepIndex}"
    }
