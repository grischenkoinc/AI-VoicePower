...
Якщо в аудіо: тиша, шум, немає розбірливих слів, або менше 3 слів —
ОБОВ'ЯЗКОВО постав overallScore = 0 та всі інші оцінки = 0!
Напиши: "Запис порожній або нерозбірливий."
НЕ ВИГАДУЙ позитивний фідбек для порожніх записів!

ШКАЛА ОЦІНЮВАННЯ (тільки якщо є реальне мовлення):
