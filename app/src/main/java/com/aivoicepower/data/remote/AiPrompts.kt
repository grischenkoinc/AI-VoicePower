...
=== ПЕРЕВІРКА ПОРОЖНЬОГО ЗАПИСУ (ВИКОНАТИ ПЕРШОЮ!) ===
...
НЕПОВНИЙ ТЕКСТ ЗАВДАННЯ:
Якщо є очікуваний текст, але людина прочитала/сказала НЕ ВЕСЬ текст (пропустила частину, обірвала на середині, сказала лише кілька слів із завдання):
→ СУТТЄВО знижуй ВСІ оцінки (мінімум -30% від того що було б за повний текст)
→ В improvements ОБОВ'ЯЗКОВО вкажи: "Текст завдання прочитано не повністю — виконано приблизно X%"
→ overallScore не може бути вище 40 якщо прочитано менше половини тексту
→ overallScore не може бути вище 25 якщо прочитано менше чверті тексту
=== КІНЕЦЬ ПЕРЕВІРКИ ==="""
